document.addEventListener('DOMContentLoaded', () => {
  const events = [
    ...
    { id: 5, title: 'Sunset Surf', date: '2025-02-28', time: '17:00', location: 'Éden GastroArts', image: '../../assets/eventos/sun_set.jpg', description: 'Descrição do evento' },
    { id: 6, title: 'Felp22 Mixing Night', date: '2025-04-12', time: '22:00', location: 'Todai-Ji', image: '../../assets/eventos/Felp22_Mixing_Night.jpg', description: 'Descrição do evento' },
    { id: 7, title: 'Jeito louco + Situasamba', date: '2025-01-04', time: '07:00', location: 'Parque do balonismo', image: '../../assets/eventos/Jeito_louco.jpg', description: 'Descrição do evento' },
    { id: 8, title: 'Mamonas Assassinas o legado', date: '2025-02-04', time: '17:00', location: 'Indoor Music Park', image: '../../assets/eventos/mamonas_assassinas.jpg', description: 'Descrição do evento' },
    { id: 9, title: 'Mc IG - Caxias do Sul', date: '2025-05-10', time: '22:00', location: 'All Need Master Hall', image: '../../assets/eventos/mc_ig.jpg', description: 'Descrição do evento' },
    { id: 10, title: 'Carnaval de inverno', date: '2025-01-13', time: '21:00', location: 'Gremio fronteira Clube', image: '../../assets/eventos/carnaval_inverno.jpg', description: 'Descrição do evento' },
    { id: 11, title: 'Mixing Night', date: '2025-02-10', time: '22:00', location: 'Todai-Ji', image: '../../assets/eventos/mixing_night.jpg', description: 'Descrição do evento' },
    { id: 12, title: 'Gaudêncio em busca do pia raiz', date: '2025-06-17', time: '18:30', location: 'Centro cultural auxiliadora', image: '../../assets/eventos/Gaudêncio.jpg', description: 'Descrição do evento' },
    { id: 13, title: 'Criciúma x Grêmio', date: '2025-01-30', time: '21:30', location: 'Estádio Heriberto Hu', image: '../../assets/eventos/Criciúma_X_Grêmio.jpg', description: 'Descrição do evento' },
    { id: 14, title: 'Livinho', date: '2025-02-06', time: '22:00', location: 'Avenida Tenis Clube', image: '../../assets/eventos/livinho.jpg', description: 'Descrição do evento' },
    { id: 15, title: 'Livinho em Lageado', date: '2025-07-24', time: '22:00', location: 'Magic club', image: '../../assets/eventos/livinho_lageado.jpg', description: 'Descrição do evento' },
    { id: 16, title: 'Thiaguinho Turnê Sorte - Tubarão também é samba', date: '2025-01-24', time: '15:00', location: 'Praça de Eventos Ivo Prim', image: '../../assets/eventos/thiaguinho.jpg', description: 'Descrição do evento' },
    { id: 17, title: 'Ana Castela - Mailing', date: '2025-02-15', time: '15:00', location: 'Mailing Lagoa', image: '../../assets/eventos/ana_castela.jpg', description: 'Descrição do evento' },
    { id: 18, title: 'Hungria em Passo Fundo', date: '2025-08-20', time: '18:00', location: 'Fazenda venice', image: '../../assets/eventos/hungria.jpg', description: 'Descrição do evento' },
    { id: 19, title: 'Zé ramalho - Am Master Hall', date: '2025-01-28', time: '20:00', location: 'Am Master Hall', image: '../../assets/eventos/ze_ramalho.jpg', description: 'Descrição do evento' },
    { id: 20, title: 'Maiara & Maraisa In Concert Curitiba', date: '2025-02-15', time: '21:30', location: 'All Need Master Hall', image: '../../assets/eventos/maiara_mariasa.jpg', description: 'Descrição do evento' },
    { id: 21, title: 'Henrique & Juliano e Rayane & Rafaela', date: '2025-09-26', time: '21:00', location: 'Efapi - Pavilhão 1 - Rua Itaboraí, S/N - Chapecó/SC', image: '../../assets/eventos/henrique_juliano.png', description: 'Descrição do evento' },
    { id: 22, title: 'Ana Castela em Bento Gonçalves', date: '2025-01-19', time: '20:00', location: 'Fundaparque - Alameda Fenavinho, 481 - Bento Gonçalves/RS', image: '../../assets/eventos/ana_castela.png', description: 'Descrição do evento' },
    { id: 23, title: 'Lauana Prado em Santa Rosa', date: '2025-02-19', time: '00:30', location: 'Arena Fenasoja - Mr. Jack.Bet - Av Benvenuto de Conti, 370 - Santa Rosa/RS', image: '../../assets/eventos/launa_prado.png', description: 'Descrição do evento' },
